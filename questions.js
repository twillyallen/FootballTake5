...
export const CALENDAR = {
  ...
  "2025-09-19": [
    ...
    { question: "Who has the most rushing TDs by a QB all-time?", choices: ["Lamar Jackson", "Michael Vick", "Cam Newton", "Jalen Hurts"], answer: 2 }
  ],
  "2025-09-20": [
    { question: "Who is 2nd All-Time in Receiving Yards after turning the age of 40?", choices: ["Jerry Rice", "Tom Brady", "Aaron Rodgers", "Steve Smith Sr."], answer: 1 },
    { question: "1st overall pick in the 2013 NFL Draft", choices: ["Andrew Luck", "Tavon Austin", "Trent Richardson", "Eric Fisher"], answer: 3 },
